...
public class ImageCreatorService : IImageCreatorService
{
    ...
    /// </summary>
    private readonly Style _titleStyle = new()
    {
    ...
    /// </summary>
    private readonly Style _infoStyle = new()
    {
        FontFamily = "Russo One",
        FontSize = 41.67f,
        TextColor = SKColors.White,
    ...
    /// </summary>
    private readonly Style _animeTitleStyle = new()
    {
        FontFamily = "Russo One",
        FontSize = 34.72f,
        TextColor = SKColors.White,
    ...
    /// Uses in status
    /// </summary>
    private readonly Style _animeReleaseStatusStyle = new()
    {
        FontFamily = "Russo One",
        FontSize = 38.89f,
    ...
    /// Uses in status
    /// </summary>
    private readonly Style _animeOngoingStatusStyle = new()
    {
        FontFamily = "Russo One",
        FontSize = 38.89f,
    ...
    /// Uses in status
    /// </summary>
    private readonly Style _animePremierStatusStyle = new()
    {
        FontFamily = "Russo One",
        FontSize = 38.89f,
    ...
    /// Uses in status
    /// </summary>
    private readonly Style _animePreviewStatusStyle = new()
    {
        FontFamily = "Russo One",
        FontSize = 38.89f,
        TextColor = SKColor.Parse("f110af")
    ...
    private readonly NavigationManager _hostEnv = default!;
    private readonly IHttpClientFactory _httpClientFactory = default!;
    private readonly ScheduleConfiguration _scheduleImageConfiguration = default!;
